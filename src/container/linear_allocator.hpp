#ifndef MOGE_SRC_CONTAINER_LINEAR_ALLOCATOR_HPP_INCLUDED
#define MOGE_SRC_CONTAINER_LINEAR_ALLOCATOR_HPP_INCLUDED
...
#endif // MOGE_SRC_CONTAINER_LINEAR_ALLOCATOR_HPP_INCLUDED
